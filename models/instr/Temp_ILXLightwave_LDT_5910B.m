...
classdef Temp_ILXLightwave_LDT_5910B < InstrClass
    ...
    methods
        % constructor
        function self = Temp_ILXLightwave_LDT_5910B()
            ...
            self.SHH_A = 1.1318e-3;
            self.SHH_B = 2.3358e-4;
            self.SHH_C = 0.90965e-7;
    ...
    methods
        function self = connect(self)
            ...
            try
                ...
                self.setThermistorModel(self.SHH_A, self.SHH_B, self.SHH_C); % A, B, C
...
%            disp(msg);
        ...
        function self = setThermistorModel(self,SHH_A,SHH_B,SHH_C)
        ...
        function self = setMaxTemp(self, temp)
            ...
            self.MaxTemp = temp;
            set_temp = strcat(['TMAX ', num2str(self.MaxTemp)]);
        ...
        function self = setMinTemp(self, temp)
            ...
            self.MinTemp = temp;
            set_temp = strcat(['TMIN ', num2str(self.MinTemp)]);
            self.send_command(set_temp);
        end
        ...
        function self = setMaxCurrent(self, current)
            ...
            set_current = strcat(['TILM ', num2str(self.MaxCurrent)]);
        ...
        function msg = setTargetTemp(self, temp)
            ...
            set_temp = strcat(['TEMP ', num2str(self.Param.TargetTemp)]);
            self.send_command(set_temp);
        ...
        function msg = setTargetCurrent(self, current)
            ...
            set_current = strcat(['TCUR ', num2str(current)]);
            self.send_command(set_current);
        ...
        function msg = setTargetR(self, resistance)
            ...
            set_R = strcat(['TRTH ',num2str(resistance)]);
            self.send_command(set_R);
