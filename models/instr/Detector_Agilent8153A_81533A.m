...
classdef Detector_Agilent8153A_81533A < InstrClass
    ...
    methods
        ...
        function self = Detector_Agilent8164A()
            ...
            self.Param.UpdatePeriod = 1; % update reading timer: min time =1s
...
%                     self.GroupObj.Utility = laser.GroupObj.Utility;
        ...
        function PowerValues = readPowerAll(self)
            try
                ...
                if err == -261
                    PowerValues(1:self.NumOfDetectors) = self.ClipLimit;
                    return
                elseif err == -231
                    PowerValues(1:self.NumOfDetectors) = -self.ClipLimit; %value questionable
                else
