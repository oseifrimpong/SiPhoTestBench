...
% xTheta Step Size Static OC
obj.gui.(parentStruct)(panelIndex).opticalStageUI.dxThetaStepOC = uicontrol(...
    'Parent', obj.gui.(parentStruct)(panelIndex).opticalStageUI.mainpanel, ...
    'Style','text', ...
    'BackgroundColor',[0.9 0.9 0.9 ], ...
    'HorizontalAlignment','left', ...
    'Units', 'normalized', ...
    'Position', [.04, .2, .2, .16], ...
    'String', 'X Theta (steps)', ...
    'FontSize', 9);
%    'String', sprintf('X Theta (%c)', char(176)), ...

% xTheta Left Button OC
obj.gui.(parentStruct)(panelIndex).opticalStageUI.dxThetaLeftOC = uicontrol(...
    'Parent', obj.gui.(parentStruct)(panelIndex).opticalStageUI.mainpanel, ...
    'Style','pushbutton', ...
    'Enable', 'on', ...
    'Units', 'normalized', ...
    ...
    'String','<', ...
    'Callback', {@dxThetaLeftOC_cb, obj, parentStruct, panelIndex});

% xTheta Step Size OC
obj.gui.(parentStruct)(panelIndex).opticalStageUI.dxThetaStepSizeOC = uicontrol(...
    'Parent', obj.gui.(parentStruct)(panelIndex).opticalStageUI.mainpanel, ...
    'Style','edit', ...
    'Enable', 'on', ...
    'Units', 'normalized', ...
...
obj.gui.(parentStruct)(panelIndex).opticalStageUI.dxThetaRightOC = uicontrol(...
    'Parent', obj.gui.(parentStruct)(panelIndex).opticalStageUI.mainpanel, ...
    'Style','pushbutton', ...
    'Enable', 'on', ...
    'Units', 'normalized', ...
...
obj.gui.(parentStruct)(panelIndex).opticalStageUI.dStaticzThetaStepOC = uicontrol(...
    'Parent', obj.gui.(parentStruct)(panelIndex).opticalStageUI.mainpanel, ...
    'Style','text', ...
    'BackgroundColor',[0.9 0.9 0.9 ], ...
    'HorizontalAlignment','left', ...
...
obj.gui.(parentStruct)(panelIndex).opticalStageUI.dzThetaLeftOC = uicontrol(...
    'Parent', obj.gui.(parentStruct)(panelIndex).opticalStageUI.mainpanel, ...
    'Style','pushbutton', ...
    'Enable', 'on', ...
    'Units', 'normalized', ...
...
% zTheta Step Size OC
obj.gui.(parentStruct)(panelIndex).opticalStageUI.dzThetaStepSizeOC = uicontrol(...
    'Parent', obj.gui.(parentStruct)(panelIndex).opticalStageUI.mainpanel, ...
    'Style','edit', ...
    'Enable', 'on', ...
    'Units', 'normalized', ...
...
obj.gui.(parentStruct)(panelIndex).opticalStageUI.dzThetaRightOC = uicontrol(...
    'Parent', obj.gui.(parentStruct)(panelIndex).opticalStageUI.mainpanel, ...
    'Style','pushbutton', ...
    'Enable', 'on', ...
    'Units', 'normalized', ...
...
% Abort button
obj.gui.(parentStruct)(panelIndex).opticalStageUI.abort = uicontrol(...
    'Parent', obj.gui.(parentStruct)(panelIndex).opticalStageUI.mainpanel, ...
    'Style','pushbutton', ...
    'Enable','on', ...
    'Units', 'normalized', ...
...
function dxThetaLeftOC_cb(~, ~, obj, parentStruct, panelIndex)
degree = str2double(get(obj.gui.(parentStruct)(panelIndex).opticalStageUI.dxThetaStepSizeOC, 'String'));
...
degree = str2double(get(obj.gui.(parentStruct)(panelIndex).opticalStageUI.dzThetaStepSizeOC, 'String'));
