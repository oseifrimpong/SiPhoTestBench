...
obj.gui.(parentStruct)(panelIndex).opticalStageUI.dXLeftButtonOC = uicontrol(...
    ...
    'Enable', 'on', ...
    'Units', 'normalized', ...
    'Position', [x, y, move_button_x, move_button_y], ...
    'String','<', ...
...
obj.gui.(parentStruct)(panelIndex).opticalStageUI.dSettingsOptical = uicontrol(...
    ...
    'Enable', 'on', ...
    'Units', 'normalized', ...
    'Position', [x, y, control_button_x, control_button_y], ...
    'String','Settings', ...
...
obj.gui.(parentStruct)(panelIndex).opticalStageUI.currentDevicePD = uicontrol(...
    ...
    'Position', [x, y, control_button_x + move_button_x*2 + 0.03, edit_y], ...
...
obj.gui.(parentStruct)(panelIndex).opticalStageUI.moveButton = uicontrol(...
    ...
    'Enable','on', ...
    'Units', 'normalized', ...
    'Position', [x, y, control_button_x*1.2, control_button_y*1.2], ...
    'String','MOVE', ...
    'FontWeight', 'bold', ...
