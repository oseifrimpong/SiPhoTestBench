...
% axes for heat map
obj.gui.panel(thisPanel).heatMapDisp = axes(...
...
if (obj.instr.opticalStage.Connected)
    % Align ui
    ui_position(4) = 0.1; % this ui hieght
    [obj, panelH] = align_ui(...
        obj, ...
        'register', ...
    ...
    isEven =  ~isEven;
    backgroundColor = panelColors(isEven+1,:);
    obj.initPanelBackgroundColor(panelH,backgroundColor);

    
    % Coordinates ui
    ui_position(2) = ui_position(2) + ui_position(4); % y position
    ui_position(4) = 0.15;
    [obj, panelH] = coordinates_ui(...
        obj, ...
        'register', ...
        obj.gui.panelFrame(thisPanel), ...
        ui_position);
...
if (obj.instr.fiberStage.Connected)
    ui_position(2) = ui_position(2) + ui_position(4);
    ui_position(4) = 0.13;
    [obj, panelH] = edge_coupled_stage_ui(...
        obj, ....
        'register', ...
        obj.gui.panelFrame(thisPanel), ...
        ui_position);
