...
function defaultStruct = applicationDefaults(rootPath)
if(nargin<1)
...
ds.AppSettings.path = struct(...
    'root', rootPath, ... 
    'userData', fullfile('C:\SiPhoTestBench\UserData'), ...
    'tempData', fullfile('C:\SiPhoTestBench\TempData'), ...
    'testData', strcat('C:',filesep), ...
    'testModeData', strcat('C:',filesep));
...
ds.AppSettings.FiberStageParams = struct(...
    'FiberStage', '<Select Fiber Stage>',...
    'COMPort', '-',...
    'FiberStageXStep', 127,...
    'FiberStageYStep', 80,...
    'FiberStageZStep', 10);
...
ds.guiDefaults.chipFiles = dir(fullfile(rootPath,'defaults','coordinateFiles','*.txt'));
